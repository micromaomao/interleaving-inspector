...
var conf = {
  ...
  onEnterRules: [{
    ...
    action: {
      indentAction: _monacoEditorCore.languages.IndentAction.IndentOutdent
    }
  }, {
    beforeText: new RegExp("<(?!(?:" + EMPTY_ELEMENTS.join('|') + "))(\\w[\\w\\d]*)([^/>]*(?!/)>)[^<]*$", 'i'),
    action: {
      indentAction: _monacoEditorCore.languages.IndentAction.Indent
    }
  }],
  folding: {
    markers: {
...
},{"../fillers/monaco-editor-core.js":"node_modules/monaco-editor/esm/vs/basic-languages/fillers/monaco-editor-core.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
