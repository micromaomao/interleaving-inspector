    ...
    if (!this._client) {
      ...
      if (this._defaults.getEagerModelSync()) {
        p = p.then(function (worker) {
          if (_this._worker) {
            return _this._worker.withSyncedResources(_monacoEditorCore.editor.getModels().filter(function (model) {
...
},{"./fillers/monaco-editor-core.js":"node_modules/monaco-editor/esm/vs/language/typescript/fillers/monaco-editor-core.js"}],"node_modules/monaco-editor/esm/vs/language/typescript/lib/lib.index.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  LibFiles.prototype.isLibFile = function (uri) {
    ...
    if (uri.path.indexOf('/lib.') === 0) {
      return !!_libIndex.libFileSet[uri.path.slice(1)];
    }
  ...
  LibFiles.prototype.getOrCreateModel = function (uri) {
    var model = _monacoEditorCore.editor.getModel(uri);
    ...
    if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
      return _monacoEditorCore.editor.createModel(this._libFiles[uri.path.slice(1)], 'javascript', uri);
    }
...
function (_super) {
  ...
  function DiagnosticsAdapter(_libFiles, _defaults, _selector, worker) {
    ...
    var onModelRemoved = function (model) {
      _monacoEditorCore.editor.setModelMarkers(model, _this._selector, []);
    ...
    _this._disposables.push(_monacoEditorCore.editor.onDidCreateModel(onModelAdd));

    _this._disposables.push(_monacoEditorCore.editor.onWillDisposeModel(onModelRemoved));

    _this._disposables.push(_monacoEditorCore.editor.onDidChangeModelLanguage(function (event) {
    ...
    _this._disposables.push({
      dispose: function () {
        for (var _i = 0, _a = _monacoEditorCore.editor.getModels(); _i < _a.length; _i++) {
          var model = _a[_i];
        ...
        switch (_b.label) {
          ...
          case 2:
            ...
            relatedUris = diagnostics.map(function (d) {
              ...
              return relatedInformation.file ? _monacoEditorCore.Uri.parse(relatedInformation.file.fileName) : null;
            });
            return [4
            /*yield*/
          ...
          case 3:
            ...
            _monacoEditorCore.editor.setModelMarkers(model, this._selector, diagnostics.map(function (d) {
  ...
  DiagnosticsAdapter.prototype._convertDiagnostics = function (model, diag) {
    ...
    if (diag.reportsUnnecessary) {
      tags.push(_monacoEditorCore.MarkerTag.Unnecessary);
    }

    if (diag.reportsDeprecated) {
      tags.push(_monacoEditorCore.MarkerTag.Deprecated);
    }
  ...
  DiagnosticsAdapter.prototype._convertRelatedInformation = function (model, relatedInformation) {
    ...
    relatedInformation.forEach(function (info) {
      ...
      if (info.file) {
        var relatedResourceUri = _monacoEditorCore.Uri.parse(info.file.fileName);
...
function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            wordRange = new _monacoEditorCore.Range(position.lineNumber, wordInfo.startColumn, position.lineNumber, wordInfo.endColumn);
            resource = model.uri;
          ...
          case 2:
            ...
            suggestions = info.entries.map(function (entry) {
              ...
              if (entry.replacementSpan) {
                ...
                range = new _monacoEditorCore.Range(p1.lineNumber, p1.column, p2.lineNumber, p2.column);
              }

              var tags = [];

              if (((_a = entry.kindModifiers) === null || _a === void 0 ? void 0 : _a.indexOf('deprecated')) !== -1) {
                tags.push(_monacoEditorCore.languages.CompletionItemTag.Deprecated);
              }
  ...
  SuggestAdapter.convertKind = function (kind) {
    switch (kind) {
      ...
      case Kind.keyword:
        return _monacoEditorCore.languages.CompletionItemKind.Keyword;

      case Kind.variable:
      case Kind.localVariable:
        return _monacoEditorCore.languages.CompletionItemKind.Variable;

      case Kind.memberVariable:
      case Kind.memberGetAccessor:
      case Kind.memberSetAccessor:
        return _monacoEditorCore.languages.CompletionItemKind.Field;
      ...
      case Kind.indexSignature:
        return _monacoEditorCore.languages.CompletionItemKind.Function;

      case Kind.enum:
        return _monacoEditorCore.languages.CompletionItemKind.Enum;

      case Kind.module:
        return _monacoEditorCore.languages.CompletionItemKind.Module;

      case Kind.class:
        return _monacoEditorCore.languages.CompletionItemKind.Class;

      case Kind.interface:
        return _monacoEditorCore.languages.CompletionItemKind.Interface;

      case Kind.warning:
        return _monacoEditorCore.languages.CompletionItemKind.File;
    }

    return _monacoEditorCore.languages.CompletionItemKind.Property;
  };
          ...
          case 2:
            ...
            , entries.map(function (entry) {
              return {
                ...
                kind: entry.isWriteAccess ? _monacoEditorCore.languages.DocumentHighlightKind.Write : _monacoEditorCore.languages.DocumentHighlightKind.Text
              };
            })];
        }
      });
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            , this._libFiles.fetchLibFilesIfNecessary(entries.map(function (entry) {
              return _monacoEditorCore.Uri.parse(entry.fileName);
            }))];
          ...
          case 3:
            ...
            for (_i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
              entry = entries_1[_i];
              uri = _monacoEditorCore.Uri.parse(entry.fileName);
          ...
          case 2:
            ...
            convert = function (bucket, item, containerLabel) {
              var result = {
                name: item.text,
                detail: '',
                kind: outlineTypeTable[item.kind] || _monacoEditorCore.languages.SymbolKind.Variable,
...
outlineTypeTable[Kind.module] = _monacoEditorCore.languages.SymbolKind.Module;
outlineTypeTable[Kind.class] = _monacoEditorCore.languages.SymbolKind.Class;
outlineTypeTable[Kind.enum] = _monacoEditorCore.languages.SymbolKind.Enum;
outlineTypeTable[Kind.interface] = _monacoEditorCore.languages.SymbolKind.Interface;
outlineTypeTable[Kind.memberFunction] = _monacoEditorCore.languages.SymbolKind.Method;
outlineTypeTable[Kind.memberVariable] = _monacoEditorCore.languages.SymbolKind.Property;
outlineTypeTable[Kind.memberGetAccessor] = _monacoEditorCore.languages.SymbolKind.Property;
outlineTypeTable[Kind.memberSetAccessor] = _monacoEditorCore.languages.SymbolKind.Property;
outlineTypeTable[Kind.variable] = _monacoEditorCore.languages.SymbolKind.Variable;
outlineTypeTable[Kind.const] = _monacoEditorCore.languages.SymbolKind.Variable;
outlineTypeTable[Kind.localVariable] = _monacoEditorCore.languages.SymbolKind.Variable;
outlineTypeTable[Kind.variable] = _monacoEditorCore.languages.SymbolKind.Variable;
outlineTypeTable[Kind.function] = _monacoEditorCore.languages.SymbolKind.Function;
outlineTypeTable[Kind.localFunction] = _monacoEditorCore.languages.SymbolKind.Function; // --- formatting ----
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            for (_i = 0, renameLocations_1 = renameLocations; _i < renameLocations_1.length; _i++) {
              ...
              edits.push({
                resource: _monacoEditorCore.Uri.parse(renameLocation.fileName),
                edit: {
...
},{"./lib/lib.index.js":"node_modules/monaco-editor/esm/vs/language/typescript/lib/lib.index.js","./fillers/monaco-editor-core.js":"node_modules/monaco-editor/esm/vs/language/typescript/fillers/monaco-editor-core.js"}],"node_modules/monaco-editor/esm/vs/language/typescript/tsMode.js":[function(require,module,exports) {
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function setupMode(defaults, modeId) {
  ...
  _monacoEditorCore.languages.registerCompletionItemProvider(modeId, new languageFeatures.SuggestAdapter(worker));

  _monacoEditorCore.languages.registerSignatureHelpProvider(modeId, new languageFeatures.SignatureHelpAdapter(worker));

  _monacoEditorCore.languages.registerHoverProvider(modeId, new languageFeatures.QuickInfoAdapter(worker));

  _monacoEditorCore.languages.registerDocumentHighlightProvider(modeId, new languageFeatures.OccurrencesAdapter(worker));

  _monacoEditorCore.languages.registerDefinitionProvider(modeId, new languageFeatures.DefinitionAdapter(libFiles, worker));

  _monacoEditorCore.languages.registerReferenceProvider(modeId, new languageFeatures.ReferenceAdapter(libFiles, worker));

  _monacoEditorCore.languages.registerDocumentSymbolProvider(modeId, new languageFeatures.OutlineAdapter(worker));

  _monacoEditorCore.languages.registerDocumentRangeFormattingEditProvider(modeId, new languageFeatures.FormatAdapter(worker));

  _monacoEditorCore.languages.registerOnTypeFormattingEditProvider(modeId, new languageFeatures.FormatOnTypeAdapter(worker));

  _monacoEditorCore.languages.registerCodeActionProvider(modeId, new languageFeatures.CodeActionAdaptor(worker));

  _monacoEditorCore.languages.registerRenameProvider(modeId, new languageFeatures.RenameAdapter(worker));

  new languageFeatures.DiagnosticsAdapter(libFiles, defaults, modeId, worker);
  return worker;
}
},{"./workerManager.js":"node_modules/monaco-editor/esm/vs/language/typescript/workerManager.js","./languageFeatures.js":"node_modules/monaco-editor/esm/vs/language/typescript/languageFeatures.js","./fillers/monaco-editor-core.js":"node_modules/monaco-editor/esm/vs/language/typescript/fillers/monaco-editor-core.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
