...
},{"./fillers/monaco-editor-core.js":"node_modules/monaco-editor/esm/vs/language/json/fillers/monaco-editor-core.js"}],"node_modules/monaco-editor/esm/vs/language/json/_deps/jsonc-parser/impl/scanner.js":[function(require,module,exports) {
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function withFormatting(text, edit, options) {
  ...
  var edits = (0, _format.format)(newText, {
    offset: begin,
    length: end - begin
  }, options.formattingOptions); // apply the formatting edits and track the begin and end offsets of the changes
...
Object.defineProperty(exports, "MarkupKind", {
  enumerable: true,
  get: function () {
    return _main.MarkupKind;
  }
});
Object.defineProperty(exports, "SelectionRange", {
  enumerable: true,
  get: function () {
    return _main.SelectionRange;
  }
});
...
Object.defineProperty(exports, "DiagnosticSeverity", {
  enumerable: true,
  get: function () {
    return _main.DiagnosticSeverity;
  }
});
...
Object.defineProperty(exports, "CompletionItemKind", {
  enumerable: true,
  get: function () {
    return _main.CompletionItemKind;
  }
});
...
Object.defineProperty(exports, "InsertTextFormat", {
  enumerable: true,
  get: function () {
    return _main.InsertTextFormat;
  }
});
Object.defineProperty(exports, "MarkupContent", {
  enumerable: true,
  get: function () {
    return _main.MarkupContent;
  }
});
...
Object.defineProperty(exports, "SymbolKind", {
  enumerable: true,
  get: function () {
    return _main.SymbolKind;
  }
});
Object.defineProperty(exports, "DocumentSymbol", {
  enumerable: true,
  get: function () {
    return _main.DocumentSymbol;
  }
});
Object.defineProperty(exports, "Location", {
  enumerable: true,
  get: function () {
    return _main.Location;
  }
});
...
function parse(textDocument, config) {
  ...
  function _parseArray(parent) {
    ...
    /* EOF */
      ...
      if (!item) {
        _error(localize('PropertyExpected', 'Value expected'), _jsonLanguageTypes.ErrorCode.ValueExpected, undefined, [], [4
        /* CloseBracketToken */
        , 5
        /* CommaToken */
        ]);
  ...
  function _parseObject(parent) {
    ...
    /* EOF */
      ...
      if (!property) {
        _error(localize('PropertyExpected', 'Property expected'), _jsonLanguageTypes.ErrorCode.PropertyExpected, undefined, [], [2
        /* CloseBraceToken */
        , 5
        /* CommaToken */
        ]);
        ...
        if (schemaProperties_1) {
          Object.keys(schemaProperties_1).forEach(function (key) {
            ...
            if (typeof propertySchema === 'object' && !propertySchema.deprecationMessage && !propertySchema.doNotSuggest) {
              ...
              if (proposal.insertText && (0, _strings.endsWith)(proposal.insertText, "$1" + separatorAfter)) {
                proposal.command = {
                  title: 'Suggest',
  ...
  JSONHover.prototype.doHover = function (document, position, doc) {
    ...
    return this.schemaService.getSchemaForResource(document.uri, doc).then(function (schema) {
      if (schema && node) {
        ...
        var markdownEnumValueDescription_1 = undefined,
            enumValue_1 = undefined;
...
},{"process":"node_modules/process/browser.js"}],"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonSchemaService.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  JSONDocumentSymbols.prototype.findDocumentSymbols = function (document, doc, context) {
    ...
    var limit = context.resultLimit || Number.MAX_VALUE; // special handling for key bindings
...
function isRef(node) {
  return node.type === 'string' && node.parent && node.parent.type === 'property' && node.parent.valueNode === node && node.parent.keyNode.value === "$ref" || false;
}
...
},{"../jsonLanguageTypes.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageTypes.js"}],"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageService.js":[function(require,module,exports) {
"use strict";
...
var _jsonDefinition = require("./services/jsonDefinition.js");
...
function getLanguageService(params) {
  ...
  return {
    ...
    findDefinition: _jsonDefinition.findDefinition,
...
function () {
  function DiagnosticsAdapter(_languageId, _worker, defaults) {
    ...
    this._disposables.push({
      dispose: function () {
        _monacoEditorCore.editor.getModels().forEach(onModelRemoved);
  ...
  DiagnosticsAdapter.prototype._doValidate = function (resource, languageId) {
    this._worker(resource).then(function (worker) {
      return worker.doValidation(resource.toString()).then(function (diagnostics) {
        ...
        var model = _monacoEditorCore.editor.getModel(resource);

        if (model && model.getModeId() === languageId) {
          _monacoEditorCore.editor.setModelMarkers(model, languageId, markers);
        }
      });
...
function toLocation(location) {
  return {
    uri: _monacoEditorCore.Uri.parse(location.uri),
...
function setupMode(defaults) {
  ...
  function registerProviders() {
    ...
    if (modeConfiguration.tokens) {
      providers.push(_monacoEditorCore.languages.setTokensProvider(languageId, (0, _tokenization.createTokenizationSupport)(true)));
    }

    if (modeConfiguration.colors) {
      providers.push(_monacoEditorCore.languages.registerColorProvider(languageId, new languageFeatures.DocumentColorAdapter(worker)));
    }
  ...
  registerProviders();
  disposables.push(_monacoEditorCore.languages.setLanguageConfiguration(defaults.languageId, richEditConfiguration));
